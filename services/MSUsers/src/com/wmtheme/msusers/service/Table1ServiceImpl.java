...
public class Table1ServiceImpl implements Table1Service {
    ...
    @Transactional(value = "MSUsersTransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "MSUsersTransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "MSUsersTransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service MSUsers for table Table1 to {} format", exportType);
